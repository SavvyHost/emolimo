...
Route::group(['middleware' => ['IsInstalled', 'lang_check_user', 'front_enable']], function () {
    ...
    Route::post('journey-details', 'FrontEnd\HomeController@getJourneyData')->name('getJourneyData');
    Route::get('journey-details', 'FrontEnd\HomeController@getNewJourney')->name('getNewJourney');
    Route::get('booking-summary', 'FrontEnd\HomeController@bookingSummary')->name('bookingSummary');
    Route::post('booking-summary', 'FrontEnd\HomeController@getBookingSummary')->name('getBookingSummary');
    Route::post('/customer-booking-store', 'FrontEnd\HomeController@StoreBookingAndCustomer')->name('registerCustomerAndBooking');
});
