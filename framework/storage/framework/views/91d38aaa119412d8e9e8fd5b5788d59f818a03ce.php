...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.add_fuel'); ?></li>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group row">
              <div class="col-md-6">
                <h4><?php echo app('translator')->get('fleet.complete_fill_up'); ?></h4>
              </div>
              <div class="col-md-6">
                <label class="switch">
          ...
          <div class="col-md-6">
            <div class="card card-solid">
              <div class="card-header">
                <h3 class="card-title"><?php echo app('translator')->get('fleet.fuel_coming_from'); ?></h3>
              </div>
              <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/emolimo.savvyhost.co/httpdocs/framework/resources/views/fuel/create.blade.php ENDPATH**/ ?>