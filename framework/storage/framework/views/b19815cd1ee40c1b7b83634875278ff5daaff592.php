        ...
        <div class="row">
          ...
          <div class="form-group" style="margin-right: 5px">
            ...
            <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 150px">
              ...
              <option value="<?php echo e($vehicle->id); ?>" <?php if($vehicle_select == $vehicle->id): ?> selected <?php endif; ?>><?php echo e($vehicle->maker->make); ?>-<?php echo e($vehicle->vehiclemodel->model); ?>-<?php echo e($vehicle->license_plate); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/emolimo.savvyhost.co/httpdocs/framework/resources/views/reports/booking.blade.php ENDPATH**/ ?>