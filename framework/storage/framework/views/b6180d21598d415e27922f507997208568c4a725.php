...
<html>
  ...
  <body <?php if($language == "Arabic-ar"): ?> dir="rtl" <?php endif; ?>>
    ...
    window.setTimeout(function () { 
         $(".alert-success:not(.alert-dismissable)").alert('close');
    }, 3000);
...
<?php /**PATH /var/www/vhosts/emolimo.savvyhost.co/httpdocs/framework/resources/views/frontend/layouts/app.blade.php ENDPATH**/ ?>